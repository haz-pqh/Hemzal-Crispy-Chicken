  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-20 px-4">
        <AnimatedTextCharacter text="Crispy Chicken's" className="font-display text-4xl md:text-6xl font-extrabold text-brand-light/80" />
        <AnimatedTextCharacter text="Perfect Sips" className="font-display text-6xl md:text-9xl font-extrabold text-white bg-clip-text text-transparent bg-gradient-to-r from-brand-primary to-brand-secondary my-2" />
        ...
        >
          Unleash a wave of flavor that perfectly complements every crispy bite. 
          Freshly crafted beverages, designed for the bold.
        </motion.p>
        <motion.div
      ...
      >
        <a href="#drinks" onClick={(e) => { e.preventDefault(); document.getElementById('drinks')?.scrollIntoView({behavior: 'smooth'})}} aria-label="Scroll to drinks section">
