      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              At Hemzal, we believe the perfect meal is a symphony of flavors. That's why we poured our passion into creating the most legendary crispy chicken that doesn't just satisfy your hunger—it elevates your entire dining experience.
            </motion.p>
            <motion.p 
              variants={itemVariants}
              className="mt-4 text-lg text-brand-light/80 leading-relaxed"
            >
              Using only the freshest ingredients and a dash of daring creativity, each piece of chicken is a masterpiece designed to deliver the ultimate crunch and zest. It's the perfect partner in crime for your taste buds.
            </motion.p>
          ...
          >
            ...
            <img 
              ...
              alt="Chef preparing crispy chicken" 
